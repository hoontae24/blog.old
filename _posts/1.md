...
![기본 블로그 모습](/img/posts/jekyll_github_blog/jekyll_basic.png){: width="100%"}
...
![깃헙 저장소 만들기](/img/posts/jekyll_github_blog/github_first_push.png){: width="100%"}  
...
![연결된 깃헙 저장소](/img/posts/jekyll_github_blog/github_first_push.png){: width="100%"}
